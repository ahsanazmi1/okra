...
CREDIT_QUOTE_EVENT_SCHEMA = {
    ...
    "properties": {
        ...
        "data": {
            ...
            "required": ["quote_id", "actor_id", "mandate", "quote_result", "policy_version", "timestamp"],
            "properties": {
                "quote_id": {
                    "type": "string",
                ...
                "actor_id": {
                    "type": "string",
                    "description": "Actor/borrower identifier"
                },
                "mandate": {
                    "type": "object",
                    "description": "AP2 mandate information"
                },
                "quote_result": {
                    "type": "object",
                    "description": "Credit quote result",
                    "required": ["approved", "credit_limit", "apr", "term_months", "monthly_payment", "reasons", "review_required", "policy_version"],
                    "properties": {
