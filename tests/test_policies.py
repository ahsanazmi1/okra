...
from okra.policies import CreditPolicies, CreditProfile, CreditRequest
...
class TestCreditPolicies:
    ...
    def test_excellent_credit_auto_approve(self):
        ...
        profile = CreditProfile(
            credit_score=750, annual_income=Decimal("100000"), debt_to_income_ratio=Decimal("0.25")
        )
    ...
    def test_good_credit_review_required(self):
        ...
        profile = CreditProfile(
            credit_score=680, annual_income=Decimal("75000"), debt_to_income_ratio=Decimal("0.35")
        )
    ...
    def test_poor_credit_declined(self):
        ...
        profile = CreditProfile(
            credit_score=600, annual_income=Decimal("40000"), debt_to_income_ratio=Decimal("0.50")
        )
    ...
    def test_rate_tiers(self):
        ...
        for credit_score, expected_apr in test_cases:
            ...
            if quote.approved or quote.review_required:
                assert (
                    quote.apr == expected_apr
                ), f"Credit score {credit_score} should get APR {expected_apr}, got {quote.apr}"
