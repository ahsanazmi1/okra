...
def sample_mandate():
    ...
    return {
        ...
        "payment": {
            ...
            "modality": {"type": "installment", "description": "Monthly payments"},
            "auth_requirements": ["bank_verification"],
            "metadata": {"bank_name": "Chase Bank", "account_type": "checking"},
        },
    }
...
class TestDeterministicResults:
    ...
    def test_different_inputs_different_results(
        self, client, sample_mandate, sample_credit_profile
    ):
